  ...
  return (
    <nav className="flex items-center justify-between py-8">
      ...
      <div className="hidden md:flex items-center gap-8 text-sm font-mono text-zinc-400">
        <Link to="/" className={isHome ? "text-cyan-400" : "hover:text-zinc-50 transition-colors"}>~/home</Link>
        <a href="#portfolio" onClick={(e) => handleNavClick(e, 'portfolio')} className="hover:text-zinc-50 transition-colors cursor-pointer">~/portfolio</a>
        <a href="#about" onClick={(e) => handleNavClick(e, 'about')} className="hover:text-zinc-50 transition-colors cursor-pointer">~/about</a>
        <a href="#contact" onClick={(e) => handleNavClick(e, 'contact')} className="hover:text-zinc-50 transition-colors cursor-pointer">~/contact</a>
      </div>
